'use client'; // Marks this file as a client-side component for Next.js
...
import {
    ...
    PhoneIcon,
    PlayCircleIcon,
} from "@heroicons/react/20/solid"; // Importing additional icons
import { Dialog, Disclosure, Popover, Transition } from "@headlessui/react"; // Importing UI components from Headless UI

// Define the product links for the dropdown menu
const products = [
    {
        name: "Book a Stay",
...
// Define the call-to-action links for the dropdown menu
const callsToAction = [
